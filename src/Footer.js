...
import fb_icon from './images/Component (1).svg';
import tw_icon from './images/Path 2.svg';
import ig_icon from './images/Component.svg';
    ...
    <div className="bg-slate-200 text-white py-8">
        <div className="container flex md:flex-row justify-around items-center">
            ...
            <div className="flex flex-col text-center md:text-left mb-4 md:mb-0 text-black">
                <h3 className="text-xl font-semibold mb-2 text-[#0E2368]">Contact Us</h3>
                <address>
            ...
            <div className="flex flex-col gap-2 text-center md:text-right text-black">
                <div className="mb-4">
                    <h3 className="text-xl font-semibold mb-2 text-[#0E2368]">More</h3>
            ...
            <div className="flex flex-col items-start gap-2 mb-24 text-center md:text-right text-black">
                    <h3 className="text-xl text-black font-semibold mb-2 text-[#0E2368]">Social Links</h3>
                    <div className="flex justify-center space-x-4">
                        <a href="#"><img src={ig_icon} alt="Instagram" className="w-6 h-6"/></a>
                        <a href="#"><img src={tw_icon} alt="Twitter" className="w-6 h-6"/></a>
                        <a href="#"><img src={fb_icon} alt="Facebook" className="w-6 h-6"/></a>
                    </div>
                </div>
        </div>
